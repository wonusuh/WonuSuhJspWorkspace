<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@include file="./02_top.jsp" %>
		<div align="center">
			<form action="${ctx}/carOptionSelect.do?no=${carVO.getNo()}" method="post">
				<table>
					<tr height="100">
						<td align="center" colspan="3">
							<font size="6" color="gray">
								${carVO.getName()} 차량 선택 </font>
						</td>
					</tr>
					<tr>
						<td rowspan="6" width="500" align="center"><img alt="temp image" src="Uploads/${carVO.getImg()}"
								width="450"></td>
					...
					<tr>
						<td width="250" height="100" align="center">
							<c:if test="${carVO.getTotalQty() eq 0}">
				...
				<br /> <br /> <br />
				<font size="5" color="gray">차랑 정보</font>
				<p>${carVO.getInfo()}</p>
			</form>
		</div>
