...
<form action="${ctx}/memberInsert.do" method="post">
	<table class="table table-bordered">
		<tr>
			<td>아이디</td>
			<td><input class="col-12" type="text" name="id"
				required="required" /></td>
		</tr>
		<tr>
			<td>패스워드</td>
			<td><input class="col-12" type="password" name="pass"
				required="required" /></td>
		</tr>
		<tr>
			<td>이름</td>
		...
		<tr>
			<td colspan="2" align="center"><input type="submit" value="가입"
				class="col-3 btn btn-primary" /> <input type="reset" value="취소"
				class="col-3 btn btn-warning" /></td>
		</tr>
	</table>
</form>
</body>
